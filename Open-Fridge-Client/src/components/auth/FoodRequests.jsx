...
const FoodRequests = props => {
  ...
  const acceptRequest = (e, requestId) => {
    axios({
      method: "post",
      withCredentials: "true",
                ...
                <div className='card' style={equalHeight}>
                  ...
                  <div className='card-content'>
                      ...
                      <div className='media-left'>
                        <figure className='image is-48x48'>
                          <img
                            ...
                            }/images/${foodRequest.foodConsumer.img &&
                    ...
                    <div className='content'>
                      ...
                      <div>
                        Requested:{" "}
                        {moment(foodRequest.createdAt).format("DD-MM-YY")}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='modal-card'>
                    ...
                    <footer className='modal-card-foot'>
                      <button
                        ...
                        onClick={e => acceptRequest(e, foodRequest._id)}
                      >
                        Cool!
                      </button>
                      <button
