          ...
          {foodOffers &&
            foodOffers.map((foodOffer, index) => (
              <div className='column is-one-quarter' key={foodOffer._id}>
                <div className='card has-background-light' style={equalHeight}>
                  <div
                  ...
                  <div className='card-content has-text-grey-dark'>
                    <div className='media'>
                      <div className='media-left'>
                        <figure className='image is-48x48'>
                          <img
                            ...
                            }/images/${foodOffer.foodSupplier.img &&
                      ...
                      <div className='media-content'>
                        ...
                        <p className='subtitle is-6 has-text-black-ter'>
                          {foodOffer.foodSupplier.lastName}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className='content'>
                      ...
                      <div>
                        Offered:{" "}
                        {moment(foodOffer.createdAt).format("DD-MM-YY")}
                      </div>
                      <div>
                        {foodOffer.expiryDate &&
                          "Will expire in: " +
                            moment(foodOffer.expiryDate).toNow(true)}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='modal-card'>
                    ...
                    <section className='modal-card-body'>
                      ...
                      <div className='media'>
                        ...
                        <div className='media-content has-text-black-ter'>
                          ...
                          <p className='subtitle is-6 has-text-black-ter'>
                            {foodOffer.foodSupplier.lasttName}
                          </p>
                        </div>
                      </div>
                    </section>
                    <footer className='modal-card-foot'>
                      <button
                        ...
                        onClick={e => acceptOffer(e, foodOffer._id)}
                      >
                        Cool!
                      </button>
                      <button
